            ...
            <div className="relative bg-slate-800 rounded-2xl shadow-2xl border border-slate-700 max-w-lg w-full p-8 transform transition-all">
                ...
                <div className="flex items-center gap-4 mb-6">
                    ...
                    <div>
                        ...
                        <p className="text-slate-400 text-sm">Enter room code to join conversation</p>
                    </div>
                </div>
                ...
                <div className="space-y-5">
                    ...
                    <div>
                        ...
                        <input
                            ...
                            maxLength={4}
                            className="w-full bg-slate-700 border border-slate-600 rounded-xl px-4 py-3 text-white placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all text-center text-2xl font-mono tracking-widest"
                        />
                        {showError && (
