...
const LandingPage = () => {
    ...
    return (
        <div className="bg-gray-950 min-h-screen">
                ...
                <div className="max-w-7xl mx-auto relative z-10">
                    <div className="text-center max-w-4xl mx-auto">
                        <div className="inline-block mb-4">
                            <span className="bg-teal-500/10 text-teal-400 px-4 py-2 rounded-full text-sm font-medium border border-teal-500/20">
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
                            ...
                            className="px-8 py-4 bg-gradient-to-r from-teal-600 to-emerald-600 text-white rounded-lg text-lg font-semibold hover:from-teal-700 hover:to-emerald-700 transition-all duration-200 shadow-lg hover:shadow-xl transform hover:-translate-y-1 w-full sm:w-auto">
                                Start Chatting Now
                            </button>
                            <button className="px-8 py-4 bg-gray-800 text-white rounded-lg text-lg font-semibold hover:bg-gray-700 transition-all duration-200 border border-gray-700 w-full sm:w-auto">
                                Watch Demo
                            </button>
                        </div>
            ...
            {/* Features Section */}
            <section id="features" className="py-20 px-4 sm:px-6 lg:px-8 bg-blue-900/50">
                <div className="max-w-7xl mx-auto">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                        {/* Feature 1 */}
                        <div className="bg-gray-800/50 backdrop-blur-sm border border-gray-700 rounded-xl p-6 hover:border-teal-500/50 transition-all duration-300 group">
                            <div className="w-12 h-12 bg-gradient-to-br from-teal-500 to-emerald-600 rounded-lg flex items-center justify-center mb-4 group-hover:scale-110 transition-transform duration-300">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        ...
                        <div className="text-center">
                            <div className="relative inline-flex items-center justify-center w-20 h-20 mb-6">
                                <div className="absolute inset-0 bg-gradient-to-br from-teal-500 to-emerald-600 rounded-full animate-pulse"></div>
                                <div className="relative bg-blue-900 rounded-full w-16 h-16 flex items-center justify-center">
                        ...
                        <div className="text-center">
                            <div className="relative inline-flex items-center justify-center w-20 h-20 mb-6">
                                <div className="absolute inset-0 bg-gradient-to-br from-teal-500 to-emerald-600 rounded-full animate-pulse animation-delay-1000"></div>
                                <div className="relative bg-blue-900 rounded-full w-16 h-16 flex items-center justify-center">
                        ...
                        <div className="text-center">
                            <div className="relative inline-flex items-center justify-center w-20 h-20 mb-6">
                                <div className="absolute inset-0 bg-gradient-to-br from-teal-500 to-emerald-600 rounded-full animate-pulse animation-delay-2000"></div>
                                <div className="relative bg-blue-900 rounded-full w-16 h-16 flex items-center justify-center">
            ...
            {/* CTA Section */}
            <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-teal-600 to-emerald-600 relative overflow-hidden">
                ...
                <div className="max-w-4xl mx-auto text-center relative z-10">
                    ...
                    <button className="px-10 py-4 bg-white text-teal-600 rounded-lg text-lg font-semibold hover:bg-gray-100 transition-all duration-200 shadow-xl hover:shadow-2xl transform hover:-translate-y-1">
